...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "MREPO-TECHNOLOGY",
  packname: process.env.PACK_NAME || "MREPO-TECHNOLOGY",
  botname : process.env.BOT_NAME  || "MREPO-BOT",
  ownername:process.env.OWNER_NAME|| "MREPO",
